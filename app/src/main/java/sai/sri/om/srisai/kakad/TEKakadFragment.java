 ...
 */
public class TEKakadFragment extends Fragment implements View.OnClickListener {

    View myView;

    public TEKakadFragment() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.te_kakad, container, false);
